...
from PIL import Image, ImageStat# app.py
import streamlit as st
import pandas as pd
import numpy as np
from datetime import datetime
...
html, body, [class*="css"] {
    ...
    background-color: #e6f2e6; /* سبز ملایم */
}
.stButton>button {
    cursor: pointer;
...
if st.session_state['user_id'] is None:
    ...
    # --- ادامه بخش‌های پایش، زمان‌بندی، پیش‌بینی و بیماری مشابه قبل با کارت‌ها و رنگ‌بندی ---
    # می‌توانم ادامه کد کامل را هم به همین سبک کارت‌ها، نمودارها و جدول‌ها آماده کنم.
